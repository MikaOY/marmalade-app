package md5c22c0b50c42be5adfbf7a87236a4e6c6;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ProjectMarmalade.Droid.GetLocation, ProjectMarmalade.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GetLocation.class, __md_methods);
	}


	public GetLocation () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GetLocation.class)
			mono.android.TypeManager.Activate ("ProjectMarmalade.Droid.GetLocation, ProjectMarmalade.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
